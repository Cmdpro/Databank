...
public class BlockEntityKeyframeAnimations {
    public static void animate(DatabankBlockEntityModel<?> pModel, AnimationDefinition pAnimationDefinition, long pAccumulatedTime, float pScale, Vector3f pAnimationVecCache) {
